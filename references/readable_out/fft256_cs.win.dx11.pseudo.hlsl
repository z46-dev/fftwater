...
// Source container: fft256_cs.win.dx11.fxo
//
...
void cs_00_cs_5_0()
{
    ...
    r0.xy = load_structured(l(0), r0.x, g0.xyxx);
...
void cs_01_cs_5_0()
{
    ...
    float4 r[3];
    // numthreads(16, 16, 1)
    r0.xy = (l(256, 256, 0, 0) < vThreadID.xyxx);
    r0.x = r0.y | r0.x;
    if (r0.x) {
        return;
    }
...
void cs_02_cs_5_0()
{
    ...
    float4 r[7];
    // numthreads(16, 16, 1)
    // asm: ige r0.xy, vThreadID.xyxx, l(256, 256, 0, 0)
    r0.x = r0.y | r0.x;
    if (r0.x) {
        return;
    }
    r0.xyzw = vThreadID.xyxy + l(-1, 0, 1, 0);
    r0.xyzw = r0.zwxy & l(255, 255, 255, 255);
    r1.xyzw = vThreadID.xyxy + l(0, -1, 0, 1);
    r1.xyzw = r1.zwxy & l(255, 255, 255, 255);
    r2.xy = r0.zwzz;
    r2.zw = l(0,0,0,0);
    ...
    r6.y = r0.w * l(0.003906);
    r6.zw = (r0.xxxx * l(0.000000, 0.000000, 0.003906, 0.003906)) + l(0.000000, 0.000000, -0.003906, 0.003906);
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r1.x, r6.zyzz, t1.xyzw, s0, l(0.000000)
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r1.w, r6.wyww, t1.yzwx, s0, l(0.000000)
    r1.x = r1.w + r1.x;
    r6.xyzw = (r0.xwxw * l(0.003906, 0.003906, 0.003906, 0.003906)) + l(0.000000, -0.003906, 0.000000, 0.003906);
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r0.x, r6.xyxx, t1.xyzw, s0, l(0.000000)
    r0.x = r0.x + r1.x;
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r0.w, r6.zwzz, t1.yzwx, s0, l(0.000000)
    r0.x = r0.w + r0.x;
    ...
    return;
    // asm: // Approximately 78 instruction slots used
}
...
void cs_03_cs_5_0()
{
    ...
    r5.y = r1.w * l(0.003906);
    r5.zw = (r1.xxxx * l(0.000000, 0.000000, 0.003906, 0.003906)) + l(0.000000, 0.000000, -0.003906, 0.003906);
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r0.w, r5.zyzz, t1.yzwx, s0, l(0.000000)
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r2.x, r5.wyww, t1.xyzw, s0, l(0.000000)
    r0.w = r0.w + r2.x;
    r5.xyzw = (r1.xwxw * l(0.003906, 0.003906, 0.003906, 0.003906)) + l(0.000000, -0.003906, 0.000000, 0.003906);
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r1.x, r5.xyxx, t1.xyzw, s0, l(0.000000)
    r0.w = r0.w + r1.x;
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r1.x, r5.zwzz, t1.xyzw, s0, l(0.000000)
    r0.w = r0.w + r1.x;
    r0.w = r0.w * l(0.250000);
    ...
    store_uav_typed(u0.xyzw, vThreadID.xyyy, r4.xyzw);
    return;
    // asm: // Approximately 76 instruction slots used
}
