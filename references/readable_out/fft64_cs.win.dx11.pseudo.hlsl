...
// Source container: fft64_cs.win.dx11.fxo
//
...
void cs_01_cs_5_0()
{
    ...
    float4 r[3];
    // numthreads(16, 16, 1)
    r0.xy = (l(64, 64, 0, 0) < vThreadID.xyxx);
    r0.x = r0.y | r0.x;
    if (r0.x) {
        return;
    }
...
void cs_02_cs_5_0()
{
    ...
    float4 r[6];
    // numthreads(16, 16, 1)
    // asm: ige r0.xy, vThreadID.xyxx, l(64, 64, 0, 0)
    r0.x = r0.y | r0.x;
    if (r0.x) {
        return;
    }
    r0.xyzw = vThreadID.xyxy + l(-1, 0, 1, 0);
    r0.xyzw = r0.zwxy & l(63, 63, 63, 63);
    r1.xyzw = vThreadID.xyxy + l(0, -1, 0, 1);
    r1.xyzw = r1.zwxy & l(63, 63, 63, 63);
    r2.xy = r0.zwzz;
    r2.zw = l(0,0,0,0);
    ...
    r0.xw = r0.xxxw * l(0.015625, 0.000000, 0.000000, 0.015625);
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r0.x, r0.xwxx, t1.xyzw, s0, l(0.000000)
    r0.w = min(cb1[128].z, l(0.040000));
    r1.x = (-cb0[1].x * r0.w) + l(1.000000);
    r1.x = max(r1.x, l(0.000000));
    r1.w = (-cb0[1].y * l(6.000000)) + r5.w;
    ...
    return;
    // asm: // Approximately 69 instruction slots used
}
...
void cs_03_cs_5_0()
{
    ...
    r1.xw = r1.xxxw * l(0.015625, 0.000000, 0.000000, 0.015625);
    // asm: sample_l_indexable(texture2d)(float,float,float,float) r0.w, r1.xwxx, t1.yzwx, s0, l(0.000000)
    r1.x = min(cb1[128].z, l(0.040000));
    r1.w = (-cb0[1].x * r1.x) + l(1.000000);
    r1.w = max(r1.w, l(0.000000));
    r2.x = (-cb0[1].y * l(6.000000)) + r0.x;
    ...
    store_uav_typed(u0.xyzw, vThreadID.xyyy, r4.xyzw);
    return;
    // asm: // Approximately 67 instruction slots used
}
